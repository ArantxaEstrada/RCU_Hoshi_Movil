            ...
            return (
                <SafeAreaView style={styles.safe}>
                    ...
                    <View style={styles.loggedInContainer2}>
                        <TouchableOpacity style={styles.optionButton} onPress={() => navigation.navigate('pendientes', { data })}>
                            <Image source={require('../../img/pending.png')} />
                            <Text style={styles.optionText}>Reportes pendientes</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.optionButton} onPress={() => navigation.navigate('completados', { data })}>
